...
def create_players(game_type, score_p1=0, score_p2=0):
    ...
    player1 = PlayerClass((WIDTH * 0.3, HEIGHT / 2), TRIANGLE_COLOR_1, controls_p1)
    player2 = PlayerClass((WIDTH * 0.7, HEIGHT / 2), TRIANGLE_COLOR_2, controls_p2)
    ...
    while running:
        ...
        for projectile in projectiles[:]:
            ...
            if projectile.is_expired():
                ...
                if player1.active_projectile == projectile: player1.active_projectile = None
                if player2.active_projectile == projectile: player2.active_projectile = None
        ...
        if hasattr(player1, "draw_clouds"):
